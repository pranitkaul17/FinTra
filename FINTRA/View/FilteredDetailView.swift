...
struct FilteredDetailView: View {
    @EnvironmentObject var expenseViewModel: ExpenseView
    ...
    var body: some View {
        ScrollView(.vertical,showsIndicators: false)
        {
            VStack(spacing: 15){
                ...
                .padding(.vertical,20)
                ForEach(expenseViewModel.expenses.filter{return $0.type == expenseViewModel.tabName}){
                    expense in
